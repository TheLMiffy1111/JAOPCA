...
public class SmokingRecipeSerializer implements IRecipeSerializer {
	...
	public SmokingRecipeSerializer(Identifier key, Object input, Object output, int count, float experience, int time) {
		this(key, "", CookingBookCategory.MISC, input, output, count, experience, time);
	}

	public SmokingRecipeSerializer(Identifier key, String group, Object input, Object output, int count, float experience, int time) {
		this(key, group, CookingBookCategory.MISC, input, output, count, experience, time);
	}

	public SmokingRecipeSerializer(Identifier key, CookingBookCategory category, Object input, Object output, int count, float experience, int time) {
		this(key, "", category, input, output, count, experience, time);
	}

	public SmokingRecipeSerializer(Identifier key, String group, CookingBookCategory category, Object input, Object output, int count, float experience, int time) {
	...
	public JsonElement get() {
		...
		SmokingRecipe recipe = new SmokingRecipe(commonInfo, bookInfo, ing, stack, experience, time);
