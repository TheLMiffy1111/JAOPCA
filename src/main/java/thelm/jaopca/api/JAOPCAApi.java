...
public abstract class JAOPCAApi {
	 ...
	 */
	public abstract boolean registerTag(String type, ResourceLocation key, Supplier<ResourceLocation> objKey);
	 ...
	 * @return true if the tag location was not blacklisted in the configuration file
	 */
	public abstract boolean registerBlockTag(ResourceLocation key, IBlockProvider block);
	 ...
	 * @return true if the tag location was not blacklisted in the configuration file
	 */
	public abstract boolean registerItemTag(ResourceLocation key, IItemProvider item);
	 ...
	 * @return true if the tag location was not blacklisted in the configuration file
	 */
	public abstract boolean registerFluidTag(ResourceLocation key, IFluidProvider fluid);
