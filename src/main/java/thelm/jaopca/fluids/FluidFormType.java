...
public class FluidFormType implements IFluidFormType {
	...
	public IFluidInfo getMaterialFormInfo(IForm form, IMaterial material) {
		...
		if(info == null && FORMS.contains(form) && form.getMaterials().contains(material)) {
			info = new FluidInfo(FLUIDS.get(form, material), FLUID_TYPES.get(form, material), FLUID_BLOCKS.get(form, material), BUCKET_ITEMS.get(form, material));
	...
	public void registerMaterialForms() {
		...
		for(IForm form : FORMS) {
			...
			for(IMaterial material : form.getMaterials()) {
				...
				api.registerForgeRegistryEntry(Registry.FLUID_REGISTRY, name, ()->materialFormFluid.get().toFluid());
				...
				api.registerForgeRegistryEntry(Registry.BLOCK_REGISTRY, name, ()->materialFormFluidBlock.get().toBlock());
				...
				api.registerForgeRegistryEntry(Registry.ITEM_REGISTRY, name, ()->materialFormBucketItem.get().toItem());
