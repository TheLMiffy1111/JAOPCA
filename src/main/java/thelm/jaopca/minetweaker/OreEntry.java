...
public class OreEntry {
	...
	public IOreDictEntry getOreDictEntry(String prefix) {
		return MineTweakerMC.getOreDict(prefix+entry.getOreName());
	}

	@ZenMethod
	public IItemStack getItemStack(String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getOreStack(prefix, entry, 1));
	}

	@ZenMethod
	public IItemStack getItemStack(String name, String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getJAOPCAOrOreStack(name, prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStack(String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getFluidStack(prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStack(String name, String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getJAOPCAOrFluidStack(name, prefix, entry, 1));
	}
	...
	public IOreDictEntry getOreDictEntryExtra(String prefix) {
		return MineTweakerMC.getOreDict(prefix+entry.getExtra());
	}

	@ZenMethod
	public IItemStack getItemStackExtra(String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getOreStackExtra(prefix, entry, 1));
	}

	@ZenMethod
	public IItemStack getItemStackExtra(String name, String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getJAOPCAOrOreStackExtra(name, prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStackExtra(String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getFluidStackExtra(prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStackExtra(String name, String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getJAOPCAOrFluidStackExtra(name, prefix, entry, 1));
	}
	...
	public IOreDictEntry getOreDictEntrySecondExtra(String prefix) {
		return MineTweakerMC.getOreDict(prefix+entry.getSecondExtra());
	}

	@ZenMethod
	public IItemStack getItemStackSecondExtra(String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getOreStackSecondExtra(prefix, entry, 1));
	}

	@ZenMethod
	public IItemStack getItemStackSecondExtra(String name, String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getJAOPCAOrOreStackSecondExtra(name, prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStackSecondExtra(String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getFluidStackSecondExtra(prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStackSecondExtra(String name, String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getJAOPCAOrFluidStackSecondExtra(name, prefix, entry, 1));
	}
	...
	public IOreDictEntry getOreDictEntryThirdExtra(String prefix) {
		return MineTweakerMC.getOreDict(prefix+entry.getThirdExtra());
	}

	@ZenMethod
	public IItemStack getItemStackThirdExtra(String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getOreStackThirdExtra(prefix, entry, 1));
	}

	@ZenMethod
	public IItemStack getItemStackThirdExtra(String name, String prefix) {
		return MineTweakerMC.getIItemStack(Utils.getJAOPCAOrOreStackThirdExtra(name, prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStackThirdExtra(String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getFluidStackThirdExtra(prefix, entry, 1));
	}

	@ZenMethod
	public ILiquidStack getLiquidStackThirdExtra(String name, String prefix) {
		return (ILiquidStack)MineTweakerMC.getIIngredient(Utils.getJAOPCAOrFluidStackThirdExtra(name, prefix, entry, 1));
	}
