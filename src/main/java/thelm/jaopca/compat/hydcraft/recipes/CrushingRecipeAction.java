...
public class CrushingRecipeAction implements IRecipeAction {
	...
	public CrushingRecipeAction(String key, Object input, Object output, int count, float pressure, int time) {
	...
	public boolean register() {
		...
		for(Object in : ins) {
			HCApi.getInstance().getRecipeHandler().addCrushingRecipe(new FluidShapelessOreRecipe(stack, in).setPressure(pressure).setCraftingTime(time));
		}
		return true;
	}
}
