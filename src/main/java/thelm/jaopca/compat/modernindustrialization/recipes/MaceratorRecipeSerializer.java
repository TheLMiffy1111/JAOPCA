...
public class MaceratorRecipeSerializer implements IRecipeSerializer {
	...
	public MaceratorRecipeSerializer(ResourceLocation key, Object input, int inputCount, float inputChance, Object[] output, int eu, int duration) {
	...
	public JsonElement get() {
		...
		MachineRecipe recipe = new MIRecipeConstructor(MIMachineRecipeTypes.MACERATOR, eu, duration).recipe();
