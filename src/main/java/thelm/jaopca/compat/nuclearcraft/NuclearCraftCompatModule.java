...
public class NuclearCraftCompatModule implements IModule {
	...
	private static final Set<String> TO_DUST_BLACKLIST = new TreeSet<>(List.of(
			...
			"carbon_manganese", "carobbiite", "charcoal", "chromium", "coal", "cobalt", "copper", "diamond", "electrum",
			"emerald", "ender_pearl", "enderium", "extreme", "ferroboron", "fluorite", "gold", "graphite", "hafnium",
			"hard_carbon", "hsla_steel", "iridium", "lapis", "iron", "lead", "lead_platinum", "lithium", "lithium_manganese_dioxide",
			"lumium", "magnesium", "manganese", "manganese_dioxide", "manganese_oxide", "netherite", "netherite_scrap",
			"niobium", "osmium", "palladium", "platinum", "potassium", "pyrolitic_carbon", "quartz", "rhodochrosite",
			"shibuichi", "sic_sic_cmc", "silicon_carbide", "silver", "signalum", "sodium", "steel", "strontium", "thermoconducting",
			"thorium", "tin_silver", "tin", "titanium", "tough_alloy", "tungsten", "uranium", "villiaumite", "yttrium",
			"zinc", "zircaloy", "zirconium", "zirconium_molybdenum"));
	private static final Set<String> TO_PLATE_BLACKLIST = new TreeSet<>(List.of(
			"aluminium", "aluminum", "beryllium", "boron", "bronze", "cobalt", "copper", "electrum", "extreme", "ferroboron",
			"graphite", "hard_carbon", "hsla_steel", "iron", "lead", "lithium", "lithium_manganese_dioxide", "lumium", "magnesium",
			"manganese", "netherite", "palladium", "platinum", "sic_sic_cmc", "signalum", "silver", "steel", "thermoconducting",
