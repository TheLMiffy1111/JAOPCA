		...
		for(IMaterial material : moduleData.getMaterials()) {
			...
			if(material.getType() == MaterialType.INGOT) {
				helper.registerManufactoryRecipe(
						miscHelper.getRecipeKey("nuclearcraft.raw_material_to_dust", material.getName()),
						rawMaterialLocation, 1, dustLocation, 2, 200, 50);
			}
			else {
				helper.registerManufactoryRecipe(
						miscHelper.getRecipeKey("nuclearcraft.ore_to_dust", material.getName()),
						oreLocation, 1, dustLocation, 2, 200, 50);
			}
		}
	}
}
