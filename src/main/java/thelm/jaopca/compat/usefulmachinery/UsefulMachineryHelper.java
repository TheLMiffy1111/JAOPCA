...
public class UsefulMachineryHelper {
	...
	public boolean registerCrushingRecipe(ResourceLocation key, String group, Object input, Object output, int outputCount, Object secondOutput, int secondOutputCount, float secondChance, int time) {
		return ApiImpl.INSTANCE.registerRecipe(key, new CrushingRecipeSerializer(key, group, input, output, outputCount, secondOutput, secondOutputCount, secondChance, time));
	}

	public boolean registerCrushingRecipe(ResourceLocation key, Object input, Object output, int outputCount, Object secondOutput, int secondOutputCount, float secondChance, int time) {
		return ApiImpl.INSTANCE.registerRecipe(key, new CrushingRecipeSerializer(key, input, output, outputCount, secondOutput, secondOutputCount, secondChance, time));
	}
	...
	public boolean registerCompactingRecipe(ResourceLocation key, String group, Object input, int inputCount, Object output, int outputCount, int time, int mode) {
	...
	public boolean registerCompactingRecipe(ResourceLocation key, Object input, int inputCount, Object output, int outputCount, int time, int mode) {
