		...
		for(IMaterial material : moduleData.getMaterials()) {
			...
			if(material.hasExtra(1)) {
				...
				helper.registerCrushingRecipe(
						miscHelper.getRecipeKey("usefulmachinery.ore_to_dust", material.getName()),
						oreLocation, dustLocation, 2, extraLocation, 1, 0.1F, 200, true, true);
			}
			else {
				helper.registerCrushingRecipe(
						miscHelper.getRecipeKey("usefulmachinery.ore_to_dust", material.getName()),
						oreLocation, dustLocation, 2, 200, true, true);
			}
		}
	}
}
