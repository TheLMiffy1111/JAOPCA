...
public class MineralGrinderRecipeSerializer implements IRecipeSerializer {
	...
	public MineralGrinderRecipeSerializer(ResourceLocation key, Object input, int inputCount, Object output, int outputCount, double experience) {
		this(key, input, inputCount, output, outputCount, ItemStack.EMPTY, 0, 0, experience);
	}

	public MineralGrinderRecipeSerializer(ResourceLocation key, Object input, int inputCount, Object output, int outputCount, Object secondOutput, int secondOutputCount, double secondChance, double experience) {
