...
public class MineralGrinderRecipeSerializer implements IRecipeSerializer {
	...
	public MineralGrinderRecipeSerializer(ResourceLocation key, String group, Object input, int inputCount, Object output, int outputCount, double experience, int time, double energy) {
	...
	public MineralGrinderRecipeSerializer(ResourceLocation key, String group, Object input, int inputCount, Object output, int outputCount, Object secondOutput, int secondOutputCount, double secondChance, double experience, int time, double energy) {
	...
	public JsonElement get() {
		...
		MineralGrinderRecipe recipe = new MineralGrinderRecipe(group, List.of(ing), stack, experience, time, energy, byproducts, List.of(), List.of());
