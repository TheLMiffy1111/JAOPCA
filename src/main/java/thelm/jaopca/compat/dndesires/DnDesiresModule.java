...
@JAOPCAModule(modDependencies = "dndesires")
public class DnDesiresModule implements IModule {
	...
	public void onCommonSetup(IModuleData moduleData, FMLCommonSetupEvent event) {
		DnDesiresHelper helper = DnDesiresHelper.INSTANCE;
		...
		for(IMaterial material : moduleData.getMaterials()) {
			...
			helper.registerSeethingRecipe(
					miscHelper.getRecipeKey("dndesires.crushed_to_ingot", material.getName()),
