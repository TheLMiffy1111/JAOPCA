package thelm.jaopca.compat.dndesires.recipes;
...
public class SeethingRecipeSerializer implements IRecipeSerializer {
	...
	public JsonElement get() {
		...
		StandardProcessingRecipe.Builder<SeethingRecipe> builder = new StandardProcessingRecipe.Builder<>(SeethingRecipe::new, key);
		builder.require(ing);
		builder.withItemOutputs(outputs);
		SeethingRecipe recipe = builder.build();
