...
public class WashingRecipeSupplier implements Supplier<WashingRecipe> {
	...
	public WashingRecipeSupplier(ResourceLocation key, Object input, int inputCount, Object output, int outputCount, float experience, int time) {
		this(key, "", input, inputCount, Ingredient.EMPTY, 0, output, outputCount, experience, time);
	}

	public WashingRecipeSupplier(ResourceLocation key, String group, Object input, int inputCount, Object output, int outputCount, float experience, int time) {
		this(key, group, input, inputCount, Ingredient.EMPTY, 0, output, outputCount, experience, time);
	}

	public WashingRecipeSupplier(ResourceLocation key, Object input, int inputCount, Object secondInput, int secondInputCount, Object output, int outputCount, float experience, int time) {
		this(key, "", input, inputCount, secondInput, secondInputCount, output, outputCount, experience, time);
	}

	public WashingRecipeSupplier(ResourceLocation key, String group, Object input, int inputCount, Object secondInput, int secondInputCount, Object output, int outputCount, float experience, int time) {
