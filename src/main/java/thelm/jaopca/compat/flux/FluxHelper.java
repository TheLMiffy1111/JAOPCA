...
public class FluxHelper {
	...
	public Ingredient getCountedIngredient(Object obj, int count) {
		...
		if(obj instanceof Supplier<?>) {
			...
			itemListStream = Stream.of(new Ingredient.TagList(MiscHelper.INSTANCE.makeItemWrapperTag(new ResourceLocation((String)obj))));
		}
		else if(obj instanceof ResourceLocation) {
			itemListStream = Stream.of(new Ingredient.TagList(MiscHelper.INSTANCE.makeItemWrapperTag((ResourceLocation)obj)));
		}
