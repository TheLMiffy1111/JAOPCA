...
public class ImmersiveEngineeringModule implements IModule {
	...
	public void onCommonSetup(IModuleData moduleData, FMLCommonSetupEvent event) {
		...
		ResourceLocation slagLocation = ResourceLocation.parse("forge:slag");
		for(IMaterial material : moduleData.getMaterials()) {
			...
			api.registerShapelessRecipe(
					miscHelper.getRecipeKey("immersiveengineering.ore_to_dust_hammer", material.getName()),
					dustLocation, 1, new Object[] {
							oreLocation, hammer,
					});
			if(material.hasExtra(1)) {
				helper.registerCrusherRecipe(
						miscHelper.getRecipeKey("immersiveengineering.ore_to_dust_crusher", material.getName()),
			...
			helper.registerArcFurnaceRecipe(
					miscHelper.getRecipeKey("immersiveengineering.ore_to_ingot", material.getName()),
					new Object[] {
							oreLocation, 1,
			...
			if(material.getType() == MaterialType.INGOT) {
				...
				api.registerShapelessRecipe(
						miscHelper.getRecipeKey("immersiveengineering.raw_material_to_dust_hammer", material.getName()),
						dustLocation, 1, new Object[] {
								rawMaterialLocation, hammer,
						});
				helper.registerCrusherRecipe(
						miscHelper.getRecipeKey("immersiveengineering.raw_material_to_dust_crusher", material.getName()),
						rawMaterialLocation, new Object[] {
								dustLocation, 1,
								dustLocation, 1, 0.33333334F,
						}, 6000);
				helper.registerArcFurnaceRecipe(
						miscHelper.getRecipeKey("immersiveengineering.raw_material_to_ingot", material.getName()),
						new Object[] {
				...
				if(itemTags.contains(rawStorageBlockLocation)) {
					helper.registerCrusherRecipe(
							miscHelper.getRecipeKey("immersiveengineering.raw_storage_block_to_dust", material.getName()),
							rawStorageBlockLocation, new Object[] {
									dustLocation, 12,
							}, 54000);
					helper.registerArcFurnaceRecipe(
							miscHelper.getRecipeKey("immersiveengineering.raw_storage_block_to_ingot", material.getName()),
							new Object[] {
