...
public class ImmersiveEngineeringCompatModule implements IModule {
	...
	public void onCommonSetup(IModuleData moduleData, FMLCommonSetupEvent event) {
		...
		Item gearMold = BuiltInRegistries.ITEM.get(new ResourceLocation("immersiveengineering:mold_gear"));
		...
		Item wireMold = BuiltInRegistries.ITEM.get(new ResourceLocation("immersiveengineering:mold_wire"));
		Item hammer = BuiltInRegistries.ITEM.get(new ResourceLocation("immersiveengineering:hammer"));
		Item wirecutter = BuiltInRegistries.ITEM.get(new ResourceLocation("immersiveengineering:wirecutter"));
		for(IMaterial material : moduleData.getMaterials()) {
			...
			if(type.isIngot() && !GENERAL_BLACKLIST.contains(name) && !configToPlateBlacklist.contains(name)) {
				...
				if(itemTags.contains(plateLocation)) {
					helper.registerMetalPressRecipe(
							new ResourceLocation("jaopca", "immersiveengineering.material_to_plate."+name),
