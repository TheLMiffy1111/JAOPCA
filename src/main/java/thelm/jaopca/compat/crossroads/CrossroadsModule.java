		...
		for(IMaterial material : formRequest.getMaterials()) {
			...
			if(material.getType() == MaterialType.INGOT) {
				...
				helper.registerStampMillRecipe(
						miscHelper.getRecipeKey("crossroads.raw_material_to_grit", material.getName()),
						rawMaterialLocation, gritInfo, 3);
			}
			else {
				helper.registerStampMillRecipe(
						miscHelper.getRecipeKey("crossroads.ore_to_grit", material.getName()),
			...
			if(material.getType() == MaterialType.INGOT) {
				...
				helper.registerOreCleanserRecipe(
						miscHelper.getRecipeKey("crossroads.raw_material_to_clump", material.getName()),
						rawMaterialLocation, clumpInfo, 2);
			}
			else {
				helper.registerOreCleanserRecipe(
						miscHelper.getRecipeKey("crossroads.ore_to_clump", material.getName()),
						oreLocation, clumpInfo, 2);
			}
			helper.registerOreCleanserRecipe(
					miscHelper.getRecipeKey("crossroads.grit_to_clump", material.getName()),
					gritLocation, clumpInfo, 1);

			helper.registerBlastFurnaceRecipe(
					miscHelper.getRecipeKey("crossroads.grit_to_molten", material.getName()),
					gritLocation, moltenLocation, 90, 2);
			helper.registerBlastFurnaceRecipe(
					miscHelper.getRecipeKey("crossroads.clump_to_molten", material.getName()),
					clumpLocation, moltenLocation, 90, 1);
			api.registerSmeltingRecipe(
					miscHelper.getRecipeKey("crossroads.grit_to_nugget", material.getName()),
					gritLocation, nuggetLocation, 7, 0.7F, 200);
			api.registerBlastingRecipe(
					miscHelper.getRecipeKey("crossroads.grit_to_nugget_blasting", material.getName()),
					gritLocation, nuggetLocation, 7, 0.7F, 100);
			api.registerSmeltingRecipe(
					miscHelper.getRecipeKey("crossroads.clump_to_nugget", material.getName()),
					clumpLocation, nuggetLocation, 7, 0.7F, 200);
			api.registerBlastingRecipe(
					miscHelper.getRecipeKey("crossroads.clump_to_nugget_blasting", material.getName()),
		...
		for(IMaterial material : moduleData.getMaterials()) {
			...
			if(material.getType() == MaterialType.INGOT) {
				...
				helper.registerMillRecipe(
						miscHelper.getRecipeKey("crossroads.ore_to_raw_material", material.getName()),
						oreLocation, rawMaterialLocation, 2, byproduct, 1);
				helper.registerMillRecipe(
						miscHelper.getRecipeKey("crossroads.raw_material_to_dust", material.getName()),
						rawMaterialLocation, dustLocation, 2);
				helper.registerBlastFurnaceRecipe(
						miscHelper.getRecipeKey("crossroads.raw_material_to_molten", material.getName()),
						rawMaterialLocation, moltenLocation, 180, 4);
				helper.registerCrucibleRecipe(
						miscHelper.getRecipeKey("crossroads.raw_material_to_molten_crucible", material.getName()),
						rawMaterialLocation, moltenLocation, 180);
			}
			else {
				helper.registerMillRecipe(
						miscHelper.getRecipeKey("crossroads.ore_to_dust", material.getName()),
						oreLocation, dustLocation, 2, byproduct, 1);
				helper.registerBlastFurnaceRecipe(
						miscHelper.getRecipeKey("crossroads.ore_to_molten", material.getName()),
						oreLocation, moltenLocation, 180, 4);
				helper.registerCrucibleRecipe(
						miscHelper.getRecipeKey("crossroads.ore_to_molten_crucible", material.getName()),
