...
public class EmbersHelper {
	...
	public static final Codec<FluidIngredient> FLUID_INGREDIENT_CODEC = ExtraCodecs.JSON.xmap(json -> FluidIngredient.deserialize(json, ""), FluidIngredient::serialize);
	public static final Codec<FluidOutput> FLUID_OUTPUT_CODEC = ExtraCodecs.JSON.xmap(json -> FluidOutput.fromJson(json.getAsJsonObject()), FluidOutput::toJson);
