...
public class PulverizerRecipeSerializer implements IRecipeSerializer {
	...
	public PulverizerRecipeSerializer(Identifier key, Object input, Object output, int outputCount, int time) {
		this(key, input, output, outputCount, ItemStack.EMPTY, 0, time);
	}

	public PulverizerRecipeSerializer(Identifier key, Object input, Object output, int outputCount, Object secondOutput, int secondOutputCount, int time) {
	...
	public JsonElement get() {
		...
		OritechRecipe recipe = new OritechRecipe(List.of(ing), results, Optional.empty(), List.of(), time, RecipeContent.PULVERIZER.get());
