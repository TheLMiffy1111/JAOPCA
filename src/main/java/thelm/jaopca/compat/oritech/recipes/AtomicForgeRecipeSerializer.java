...
public class AtomicForgeRecipeSerializer implements IRecipeSerializer {
	...
	public AtomicForgeRecipeSerializer(Identifier key, Object input, Object secondInput, Object thirdInput, Object output, int outputCount, int time) {
	...
	public JsonElement get() {
		...
		OritechRecipe recipe = new OritechRecipe(inputs, List.of(stack), Optional.empty(), List.of(), time, RecipeContent.ATOMIC_FORGE.get());
