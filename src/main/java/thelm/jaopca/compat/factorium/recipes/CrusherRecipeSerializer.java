...
public class CrusherRecipeSerializer implements IRecipeSerializer {
	...
	public CrusherRecipeSerializer(ResourceLocation key, Object input, Object output, int outputCount, float outputChance) {
		this(key, input, output, outputCount, outputChance, ItemStack.EMPTY, 0, 0, ItemStack.EMPTY, 0, 0);
	}

	public CrusherRecipeSerializer(ResourceLocation key, Object input, Object output, int outputCount, float outputChance, Object secondOutput, int secondOutputCount, float secondOutputChance, Object thirdOutput, int thirdOutputCount, float thirdOutputChance) {
	...
	public JsonElement get() {
		...
		json.addProperty("type", "factorium:crusher");
