...
public class ExtractorRecipeSerializer implements IRecipeSerializer {
	...
	public ExtractorRecipeSerializer(ResourceLocation key, Object input, int inputCount, Object output, int outputCount, double time, double energy, float experience) {
