...
public class MetalFormerRollingRecipeAction implements IRecipeAction {
	...
	public MetalFormerRollingRecipeAction(String key, Object input, int inputCount, Object output, int outputCount) {
	...
	public boolean register() {
		...
		Recipes.metalformerRolling.addRecipe(ing, null, stack);
		return true;
	}
}
