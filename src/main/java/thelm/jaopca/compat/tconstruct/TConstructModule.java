...
public class TConstructModule implements IModule {
	...
	public void onCommonSetup(IModuleData moduleData, FMLCommonSetupEvent event) {
		...
		ToIntFunction<FluidStack> tempFunction = stack->stack.getFluid().getFluidType().getTemperature(stack)-300;
	...
	public ToIntFunction<FluidStack> getMeltTimeFunction(float timeFactor) {
		return stack->IMeltingRecipe.calcTime(stack.getFluid().getFluidType().getTemperature(stack)-300, timeFactor);
	}
}
