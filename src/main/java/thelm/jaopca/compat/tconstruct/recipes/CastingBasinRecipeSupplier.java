...
public class CastingBasinRecipeSupplier implements Supplier<ItemCastingRecipe.Basin> {
	...
	public CastingBasinRecipeSupplier(ResourceLocation key, Object cast, Object input, int inputAmount, Object output, int outputCount, ToIntFunction<FluidStack> time, boolean consumeCast, boolean switchSlots) {
		this(key, "", cast, input, inputAmount, output, outputCount, time, consumeCast, switchSlots);
	}

	public CastingBasinRecipeSupplier(ResourceLocation key, String group, Object cast, Object input, int inputAmount, Object output, int outputCount, ToIntFunction<FluidStack> time, boolean consumeCast, boolean switchSlots) {
	...
	@Override
	public ItemCastingRecipe.Basin get() {
