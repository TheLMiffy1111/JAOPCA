...
public class RailcraftHelper {
	...
	public boolean registerCrusherRecipe(Identifier key, Object input, int time, Object... output) {
		return ApiImpl.INSTANCE.registerRecipe(key, new CrusherRecipeSerializer(key, input, time, output));
	}

	public boolean registerRollingRecipe(Identifier key, Object output, int outputCount, int time, Object... input) {
