	...
	public void onCommonSetup(IModuleData moduleData, FMLCommonSetupEvent event) {
		...
		for(IMaterial material : dirtyDustForm.getMaterials()) {
			...
			helper.registerMillingRecipe(
					miscHelper.getRecipeKey("createmetallurgy.crushed_to_dirty_dust", material.getName()),
			...
			helper.registerSplashingRecipe(
					miscHelper.getRecipeKey("createmetallurgy.dirty_dust_to_dust", material.getName()),
