...
public class NeoVitaeModule implements IModule {
	...
	public void onCommonSetup(IModuleData moduleData, FMLCommonSetupEvent event) {
		...
		ResourceLocation cuttingFluidLocation = ResourceLocation.parse("neovitae:athanor_tool/cutting_fluids");
		ResourceLocation resonatorLocation = ResourceLocation.parse("neovitae:athanor_tool/resonator");
		Item corruptedTinyDust = BuiltInRegistries.ITEM.get(ResourceLocation.parse("neovitae:corrupted_tiny_dust"));
		Item corruptedDust = BuiltInRegistries.ITEM.get(ResourceLocation.parse("neovitae:corrupted_dust"));
		for(IMaterial material : formRequest.getMaterials()) {
			...
			ResourceLocation fragmentLocation = miscHelper.getTagLocation("neovitae:fragments", material.getName());
			IItemInfo gravelInfo = itemFormType.getMaterialFormInfo(gravelForm, material);
			ResourceLocation gravelLocation = miscHelper.getTagLocation("neovitae:gravels", material.getName());
