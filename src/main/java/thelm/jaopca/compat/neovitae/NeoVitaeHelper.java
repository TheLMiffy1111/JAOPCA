...
public class NeoVitaeHelper {
	...
	public boolean registerAlchemyTableRecipe(Identifier key, Object[] input, Object output, int count, int cost, int time, int minTier) {
		return ApiImpl.INSTANCE.registerRecipe(key, new AlchemyTableRecipeSerializer(key, input, output, count, cost, time, minTier));
	}

	public boolean registerAthanorRecipe(Identifier key, Object input, int inputCount, Object tool, Object fluidInput, int fluidInputAmount, Object[] output, Object fluidOutput, int fluidOutputAmount, Map<SpiritusType, Double> spiritusCosts, boolean spiritusBoost) {
	...
	public boolean registerAthanorRecipe(Identifier key, Object input, int inputCount, Object tool, Object[] output, Map<SpiritusType, Double> spiritusCosts, boolean spiritusBoost) {
